...
class test_flask_app(unittest.TestCase):
    def test_route_homepage(self):
        ...
        self.assertEqual(b"There are 2 functions for this app. 1. You can type in internet_access/[insert country here], and get the p", self.data)
    ...
    def test_route_internet_access(self):
        ...
        self.assertEqual(b'58.5 percent of people have access to the internet from Panama', self.data)
    ...
    def test_route_average_age(self):
        ...
        self.assertEqual(b'48.5 is the avarage age in Norway', self.data)
    def test_route_error_handler(self): 
        """" Change this to test the errors """
        self.app = app.test_client()
        response = self.app.get('average_age/Norway', follow_redirects = True)
        self.assertEqual(b'48.5 is the avarage age in Norway', self.data)
